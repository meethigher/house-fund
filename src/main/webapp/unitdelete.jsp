...
<%@ page import="top.meethigher.house.fund.domain.Unit" %>
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <form action="deleteUnit" method="post" class="row">
            <div class="col-md-6">
                ...
                <div class="input-group mb-3">
                    ...
                    <input disabled class="form-control" placeholder="联系电话"
            ...
            <div class="col-md-6">
                <div class="input-group mb-3">
                    ...
                    <select disabled id="unitchar" class="form-control">
                ...
                <div class="input-group mb-3">
                    ...
                    <select disabled id="unitkind" class="form-control">
                ...
                <div class="input-group mb-3">
                    ...
                    <input disabled type="number" max="31" min="1" class="form-control"
                ...
                <div class="input-group mb-3">
                    ...
                    <input disabled type="text" class="form-control" onkeyup="this.value=this.value.replace(/\D/g,'')"
            ...
            <div class="input-group mb-3 col-md-12">
                ...
                <textarea disabled type="text" class="form-control" maxlength="50"
